...
print(F,'~/Matlab/GaussMat/plots/Power/PS_spectraB','-dpdf','-fillpage')

figure(SVDPlot)
F = gcf;
set(F,'PaperOrientation','landscape');
set(F, 'Position', get(0, 'Screensize'));
print(F,'~/Matlab/GaussMat/plots/Power/PS_SVDB','-dpdf','-fillpage')
  ...
  name = ['PowerSysTestDat_BusArea_',num2str(N),'.mat'];
